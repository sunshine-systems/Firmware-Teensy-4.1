...
//! static export when the `KMBOX_FRONTEND_DIR` env var points at a
...
pub const FRONTEND_DIR_ENV: &str = "KMBOX_FRONTEND_DIR";
...
async fn root_fallback_message() -> &'static str {
    "KMBox Net Translator daemon — frontend not bundled in this build"
}
